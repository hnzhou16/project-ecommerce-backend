...
export class CartController {
    ...
    static async getCart(req: Request, res: Response) {
        ...
        try {
            ...
            return res.status(200).send(new ResMsg(200, 'Shopping cart saved!', cartInfo))
        } catch (err) {
            console.error('Error creating and merging the cart:', err)
    ...
    static async editItem(req: Request, res: Response) {
        ...
        try {
            ...
            if (existingCartItem) {
                existingCartItem.colorId = cartItem.colorId
